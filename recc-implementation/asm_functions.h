...
void print_aggregate_type_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct aggregate_type_specifier_id);
void print_all_simple_type_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_simple_type_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct simple_type_specifier_id);
void print_all_simple_type_qualifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_simple_type_qualifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct simple_type_qualifier_id);
...
void print_simple_storage_class_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct simple_storage_class_specifier_id);
void print_all_specifier_or_qualifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_specifier_or_qualifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct specifier_or_qualifier_id);
...
void print_specifier_or_qualifier_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct specifier_or_qualifier_list_item_id);
void print_all_parameter_lists(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_parameter_list(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct parameter_list_id);
void print_all_declarator_parts(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_declarator_part(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct declarator_part_id);
void print_all_any_statement_list_items(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_any_statement_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct any_statement_list_item_id);
void print_all_anonymous_tag_definitions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_anonymous_tag_definition(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct anonymous_tag_definition_id);
void print_all_named_tag_predeclarations(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_named_tag_predeclaration(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct named_tag_predeclaration_id);
void print_all_named_tag_definitions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_named_tag_definition(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct named_tag_definition_id);
void print_all_tag_definitions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_tag_definition(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct tag_definition_id);
...
void print_struct_or_union_member_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct struct_or_union_member_list_item_id);
void print_all_enum_member_list_items(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_enum_member_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct enum_member_list_item_id);
void print_all_enum_members(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_enum_member(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct enum_member_id);
void print_all_struct_or_union_members(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_struct_or_union_member(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct struct_or_union_member_id);
void print_all_initializers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_initializer(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct initializer_id);
void print_all_initializer_list_items(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_initializer_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct initializer_list_item_id);
void print_all_declarator_part_list_items(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_declarator_part_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct declarator_part_list_item_id);
void print_all_pointer_parts(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_pointer_part(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct pointer_part_id);
void print_all_function_parts(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_function_part(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct function_part_id);
void print_all_array_parts(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_array_part(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct array_part_id);
void print_all_general_types(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_general_type(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct general_type_id);
void print_all_identifier_namespace_entrys(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_identifier_namespace_entry(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct identifier_namespace_entry_id);
void print_all_general_type_list_items(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_general_type_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct general_type_list_item_id);
...
void print_postfix_expression_part_list_item(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct postfix_expression_part_list_item_id);
void print_all_postfix_expression_parts(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_postfix_expression_part(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct postfix_expression_part_id);
void print_all_unscoped_tag_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_unscoped_tag_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct unscoped_tag_specifier_id);
void print_all_scoped_typename_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_scoped_typename_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct scoped_typename_specifier_id);
void print_all_scoped_tag_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_scoped_tag_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct scoped_tag_specifier_id);
void print_all_unscoped_union_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_unscoped_union_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct unscoped_union_specifier_id);
void print_all_unscoped_struct_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_unscoped_struct_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct unscoped_struct_specifier_id);
void print_all_unscoped_enum_specifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_unscoped_enum_specifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct unscoped_enum_specifier_id);
void print_all_bitfields(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_bitfield(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct bitfield_id);
void print_all_jump_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_jump_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct jump_statement_id);
void print_all_switch_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_switch_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct switch_statement_id);
void print_all_if_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_if_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct if_statement_id);
void print_all_while_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_while_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct while_statement_id);
void print_all_for_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_for_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct for_statement_id);
void print_all_code_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_code_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct code_statement_id);
void print_all_labeled_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_labeled_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct labeled_statement_id);
void print_all_postfix_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_postfix_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct postfix_expression_id);
void print_all_primary_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_primary_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct primary_expression_id);
void print_all_any_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_any_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct any_statement_id);
void print_all_scoped_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_scoped_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct scoped_statement_id);
void print_all_declaration_statements(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_declaration_statement(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct declaration_statement_id);
void print_all_function_definitions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_function_definition(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct function_definition_id);
void print_all_simple_declarations(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_simple_declaration(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct simple_declaration_id);
void print_all_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct expression_id);
void print_all_cast_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_cast_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct cast_expression_id);
void print_all_unary_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_unary_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct unary_expression_id);
void print_all_binary_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_binary_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct binary_expression_id);
void print_all_ternary_expressions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_ternary_expression(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct ternary_expression_id);
void print_all_constant_descriptions(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_constant_description(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct constant_description_id);
void print_all_data_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_data_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct data_package_id);
void print_all_error_nodes(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_error_node(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct error_node_id);
void print_all_byte_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_byte_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct byte_package_id);
void print_all_hword_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_hword_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct hword_package_id);
void print_all_word_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_word_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct word_package_id);
void print_all_qword_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_qword_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct qword_package_id);
void print_all_dword_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_dword_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct dword_package_id);
void print_all_string_packages(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_string_package(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct string_package_id);
void print_all_identifiers(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_identifier(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct identifier_id);
void print_all_scope_guids(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_scope_guid(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct scope_guid_id);
void print_all_anonymous_entrys(struct asm_state * state, unsigned int scope_depth, struct unsigned_char_list * out);
void print_anonymous_entry(struct asm_state *, unsigned int scope_depth, struct unsigned_char_list *, struct anonymous_entry_id);
...
struct named_tag_predeclaration_id make_named_tag_predeclaration_named(struct asm_state *, struct scope_guid_id, struct identifier_id, enum asm_unscoped_tag_specifier_kind);
...
struct identifier_namespace_entry_id make_identifier_namespace_entry_typedef(struct asm_state *, struct identifier_id, struct scope_guid_id, struct general_type_id);
struct identifier_namespace_entry_id make_identifier_namespace_entry_declaration(struct asm_state *, struct identifier_id, struct scope_guid_id, struct general_type_id);
