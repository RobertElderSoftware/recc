...
struct asm_state{
	...
	struct struct_layout_flag_list_item_details_list layout_flag_list_items;
	struct struct_layout_flag_list_item_details_to_struct_layout_flag_list_item_id_map layout_flag_list_items_map;
	struct struct_layout_flag_details_list layout_flags;
	struct struct_layout_flag_details_to_struct_layout_flag_id_map layout_flags_map;
	...
	struct struct_expression_list_item_details_list expression_list_items;
	struct struct_expression_list_item_details_to_struct_expression_list_item_id_map expression_list_items_map;
	...
	struct struct_typedef_entry_details_list typedef_entrys;
	struct struct_typedef_entry_details_to_struct_typedef_entry_id_map typedef_entrys_map;
	...
	struct struct_anonymous_instance_details_list anonymous_instances;
	struct struct_anonymous_instance_details_to_struct_anonymous_instance_id_map anonymous_instances_map;
	unsigned int last_scope_guid;
};
