...
#define TYPES_DATA_STRUCTURES_struct_struct_parser_node_ptr_to_unsigned_int_map_H_
/*
...
#include "../parser/struct_parser_node.h"
#endif

struct struct_parser_node_ptr_to_unsigned_int_map{
	struct binary_exponential_buffer key_value_pairs;
	int (*compare)(struct parser_node *, struct parser_node *);
};
