#ifndef __TYPES_DATA_STRUCTURES_struct_unsigned_char_ptr_to_struct_macro_definition_ptr_map_H__
#define __TYPES_DATA_STRUCTURES_struct_unsigned_char_ptr_to_struct_macro_definition_ptr_map_H__
/*
...
struct unsigned_char_ptr_to_struct_macro_definition_ptr_map{
	...
	int (*compare)(unsigned char *, struct macro_definition *);
};
