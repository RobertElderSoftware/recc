#ifndef TYPES_DATA_STRUCTURES_struct_unsigned_char_ptr_to_struct_macro_definition_ptr_map_H__
#define TYPES_DATA_STRUCTURES_struct_unsigned_char_ptr_to_struct_macro_definition_ptr_map_H__
/*
